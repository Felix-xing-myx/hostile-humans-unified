...
本模组由原模组 [**Hostile Humans**](https://www.curseforge.com/minecraft/mc-mods/hostile-humans) 修改衍生，并整合了 **Human Gunner** 的相关内容。同时，本模组也加入了一些原创的新内容。它可以单独安装使用，不需要另外安装原版 Hostile Humans 或 Human Gunner。本模组的修改与构建过程中使用了 GPT 辅助。本版本由第三方维护，并非原作者发布的官方更新。
